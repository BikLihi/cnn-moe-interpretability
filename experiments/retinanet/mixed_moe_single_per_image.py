...
from models.retina.retinanet import model_single_gating_last_layer, coco_eval
...
def main(args=None):
    ...
    initial_lr = 1e-5
    project_name = 'MoE_mixed_overall_loss_w=0.25_FCGate_single_gating_per_image'
    ...
    # Create the model
    retinanet = model_single_gating_last_layer.resnet50(num_classes=dataset_train.num_classes(),)
    ...
    retinanet.classificationModel = model_single_gating_last_layer.ClassificationModelMoEOutputLayer(num_features_in=256, num_experts=4, top_k=2, gating_network=gate, num_classes=dataset_train.num_classes())
    retinanet.regressionModel = model_single_gating_last_layer.RegressionModelMoEOutputLayer(num_features_in=256, num_experts=4, top_k=2, gating_network=gate)
