...
from models.retina.retinanet import model_last_layer_moe, coco_eval
...
def main(args=None):
    ...
    enable_logging = True
    initial_lr = 1e-5
    project_name = 'MoE_mixed_overall_loss_w=0.25_FCGate_2Gates_Last_layer_FC'
    ...
    retinanet.classificationModel = model_single_gating_last_layer.ClassificationModelMoEConv4(num_features_in=256, num_experts=4, top_k=2, gating_network=gate1, num_classes=dataset_train.num_classes())
    retinanet.regressionModel = model_single_gating_last_layer.RegressionModelMoEConv4(num_features_in=256, num_experts=4, top_k=2, gating_network=gate2)
