...
from models.retina.retinanet import model_single_gating, coco_eval
...
def main(args=None):
    ...
    enable_logging = True
    initial_lr = 1e-5
    project_name = 'MoE_mixed_overall_loss_c=0.3_FCGate_single_gating_hard_constrained'
    ...
    # Create the model
    retinanet = model_single_gating.resnet50(num_classes=dataset_train.num_classes(),)
    ...
    gate = gating_network(in_channels=256, 
                        ...
                        top_k=2,
                        use_noise=True,
                        name='FCRelativeImportance',
                        constr_threshold=0.3)

    retinanet.classificationModel = model_single_gating.ClassificationModelMoE(num_features_in=256, num_experts=4, top_k=2, gating_network=gate, num_classes=dataset_train.num_classes())
    retinanet.regressionModel = model_single_gating.RegressionModelMoE(num_features_in=256, num_experts=4, top_k=2, gating_network=gate)
