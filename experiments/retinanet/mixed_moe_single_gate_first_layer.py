...
from models.retina.retinanet import model_single_gating_first_layer, coco_eval
...
def main(args=None):
    ...
    enable_logging = True
    initial_lr = 1e-5
    project_name = 'MoE_mixed_overall_loss_w=0.25_FCGate_single_FC_first_layer'
    ...
    # Create the model
    retinanet = model_single_gating_first_layer.resnet50(num_classes=dataset_train.num_classes(), )
    ...
    # Add MoE Predictors
    gate = gating_network(in_channels=256, 
                        num_experts=4,
                        top_k=2,
                        use_noise=True,
                        name='FCGate',
    ...
    retinanet.classificationModel = model_single_gating_first_layer.ClassificationModelFirstLayerMoE(num_features_in=256, num_experts=4, top_k=2, gating_network=gate, num_classes=dataset_train.num_classes())
    retinanet.regressionModel = model_single_gating_first_layer.RegressionModelFirstLayerMoE(num_features_in=256, num_experts=4, top_k=2, gating_network=gate)
