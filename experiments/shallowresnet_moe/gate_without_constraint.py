...
# Variable parameters
num_exp_values = [4, 8]
w_aux_loss_values = [0.0]
schedule_lambda_values = [schedule_1, schedule_2]
    ...
    for schedule_lambda in schedule_lambda_values:
        for num_exp in num_exp_values:
            ...
            model = ShallowResNetMoE(
                num_blocks=1,
                moe_layer=moe_layer,
                name='ShallowResNetMoE_SimpleGate_withoutAuxLoss'
            )
            ...
            model.fit(
                ...
                wandb_name='ShallowResNetMoE_SimpleGate_withoutAuxLoss',
                wandb_tags=['compare_gates', 'SimpleGate', 'ShallowResNetMoE', 'NoAuxLoss'],
