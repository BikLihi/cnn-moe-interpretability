...
def main():
    ...
    num_expert_values = [4]
    top_k_values = [2]
    milestones_values = [[], [15], [15, 30], [15, 30, 60]]
                ...
                for gate in gate_values:
                    for i in range(2):
                        ...
                        lr_scheduler = torch.optim.lr_scheduler.MultiStepLR(
                            optimizer, milestones, gamma=10)

                        logging_dir = '/home/lb4653/mixture-of-experts-thesis/experiments/resnet_moe_layer/logs/learning_rate_tests/{}_test={}_numExp={}_topk={}_milestones={}_noise={}'.format(
                            gate.__qualname__, i, num_experts, top_k, milestones, use_noise)
                        save_state_path = '/home/lb4653/mixture-of-experts-thesis/experiments/resnet_moe_layer/trained_models/learning_rate_tests/{}_test={}_numExp={}_topk={}_milestones={}_noise={}'.format(
                            gate.__qualname__, i, num_experts, top_k, milestones, use_noise)
