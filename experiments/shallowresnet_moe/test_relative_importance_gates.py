...
from models.moe_layer.hard_gating_networks import RelativeImportanceGate
...
gating_network = RelativeImportanceGate


# Variable parameters
constr_threshold_values = [0.1]
schedule_lambda_values = [schedule_3] #[schedule_1, schedule_2, schedule_3]
num_exp_values = [4]
    ...
    for schedule_lambda in schedule_lambda_values:
        for num_exp in num_exp_values:
            ...
            model = ShallowResNetMoE(
                num_blocks=1,
                moe_layer=moe_layer,
                name='ShallowResNetMoE_RelativeImportanceGate2_exp=' + str(num_exp) + '_thresh=' + str(constr_threshold)
            )
            ...
            model.fit(
                ...
                wandb_name='ShallowResNetMoE_RelativeImportanceGate2_exp=' + str(num_exp) + '_thresh=' + str(constr_threshold),
                wandb_tags=['compare_gates', 'RelativeImportanceGate2', 'ShallowResNetMoE', 'HardConstraint'],
