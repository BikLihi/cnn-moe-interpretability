...
position_values = [[1, 2, 3, 4], [1, 2], [3, 4], [1, 4], [2, 3]]
in_channels = [64, 256, 512, 1024]
w_aux_loss = [0.5, 0.5, 0.5, 0.5]
    ...
    for loss_function in loss_function_values:
        ...
        for p in positions:
            ...
            moe_layer = BottleneckMoeLayer(
                ...
                top_k=2,
                gating_network=gate,
                resnet_expert=ResNet50Expert)
            
            moe_layers.append(moe_layer)

        model = ResNet50MoE(
            moe_layers=moe_layers,
            name='ResNet50_MoE_' + loss_function + '_w= ' + str(w_aux_loss) + '_moePosition=' + str(positions),
        ...
        model.fit(
            ...
            wandb_name='ResNet50_MoE_' + loss_function + '_w= ' + str(w_aux_loss) + '_moePosition=' + str(positions),
            wandb_tags=['MoE', 'ResNet50', 'SimpleGate', 'SoftConstraint', 'StackedMoE'],
