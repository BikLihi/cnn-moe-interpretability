        ...
        for loss_function in loss_function_values:
            for i in range(3):
                    ...
                    model = ResNet18MoE(
                        ...
                        name='Residual_' + str(num_experts) + '_topK=' + str(top_k) + '_loss=' + loss_function + '_w_aux=' + str(w_aux_loss) + '_moePosition=' + str(position) + '_' + str(i),
                    ...
                    model.fit(
                        ...
                        wandb_name='Residual' + '_numExp=' + str(num_experts) + '_topK=' + str(top_k) + '_loss=' + loss_function + '_w_aux=' + str(w_aux_loss) + '_moePosition=' + str(position) + '_' + str(i),
