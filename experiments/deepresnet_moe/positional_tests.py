...
# Variable parameters
loss_function_values = ['kl_divergence'] #['importance', 'kl_divergence']
position_values = [2, 3, 4] # [1, 2, 3, 4]
in_channels = [256, 512, 1024] #[64, 256, 512, 1024]
...
for loss_function in loss_function_values:
    for i in range(len(position_values)):
        ...
        model.fit(
            ...
            wandb_name='ResNet101_MoE_SimpleGate_' + loss_function + '_w=' + str(w_aux_loss) + '_moePosition=' + str(position_values[i]),
