...
class DeepResNetMoE(BaseModel):
    def __init__(self, moe_layers, name='DeepResNetMoE', lift_constraint=None):
        ...
        resnet = Resnet101(classes=CIFAR100_LABELS)
    ...
    def forward(self, x, output_only=True):
        ...
        for i, layer in enumerate(self.layers):
            if type(layer) is BottleneckMoeLayer:
